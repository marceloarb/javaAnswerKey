...
public class LambdaMain {
	...
	public static void main(String[] args) {
		...
		Computation summing = (List<Integer> numbers) ->{

			return numbers.stream().mapToInt(number -> number).sum();
		};
		EvenOrOdd evenOrOdd = (int i) ->{

			return i % 2 == 0;
		};

		System.out.println(Numbers.added(summing));
		System.out.println(Numbers.isEven(5,evenOrOdd));
		System.out.println(Numbers.isOdd(5,evenOrOdd));
			/* e.g.
